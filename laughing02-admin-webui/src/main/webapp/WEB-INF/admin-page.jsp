				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							<i class="glyphicon glyphicon-th"></i> 数据列表1
						</h3>
					</div>
					<div class="panel-body">
						...
						<button type="button" class="btn btn-primary"
								style="float: right;" onclick="window.location.href='admin/to/admin-add.html'">
						...
						<div class="table-responsive">
							<table class="table  table-bordered">
								...
								<c:if test="${requestScope.pageInfo.list==null }">
									<tr>
										<td colspan="6" align="center">抱歉！没有查询到您要的数据！

										</td>
									</tr>
								</c:if>
								<c:if test="${requestScope.pageInfo.list!=null }">
									<%--items返回的列表 admin遍历的临时对象 varStatus 计数器--%>
									<c:forEach items="${requestScope.pageInfo.list }" var="admin" varStatus="myStatus">
										<tr>
											...
											<td>
												...
												<a href="admin/toModifyAdmin.html?id=${admin.id}&keyword=${param.keyword}&pageNum=${requestScope.pageInfo.pageNum}"
												   class="btn btn-primary btn-xs">
													<i class=" glyphicon glyphicon-pencil"></i>
												</a>
												<a href="admin/delAdminById.html?keyword=${param.keyword}&pageNum=${requestScope.pageInfo.pageNum}&id=${admin.id}"
